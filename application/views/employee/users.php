        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>employee/addNew"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'employee/editOld/'.$record->id; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
